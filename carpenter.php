...
$filterAvailability = isset($_POST['availability']) ? $_POST['availability'] : '';
$searchTerm = isset($_POST['search']) ? $_POST['search'] : '';

$sql = "SELECT * FROM suppliers WHERE services = 'carpenter'";

if ($filterAvailability) {
    $sql .= " AND availability = '$filterAvailability'";
}

if ($searchTerm) {
    $sql .= " AND (company_name LIKE '%$searchTerm%' OR services_offered LIKE '%$searchTerm%' OR address LIKE '%$searchTerm%')";
}
 ...
 Search by Company Name, Location, or Services" />
    ...
    <div class="main-container">
        ...
        <div class="plumber-text">
            <h1>Best Carpentery Services</h1>
            <h1> in Tamilnadu</h1>
            <p>
            ...
            <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                        <img src="carr.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="carp.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
    ...
    <div class="services-container">
        ...
        <div class="service-list" id="service-list">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<p>No carpenter services available currently.</p>";
            }
            ?>
        </div>
    </div>
