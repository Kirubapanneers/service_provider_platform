...
// Securely include your database connection (this file should be in .gitignore)
require_once 'config.php'; // Ensure this file is never pushed to GitHub
 ...
 Search by Company Name, Location, or Services" />
    ...
    <div class="main-container">
        ...
        <div class="plumber-text">
            <h1>Best Electrician Services</h1>
            <h1> in Tamilnadu</h1>
            <p>
            ...
            <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                        <img src="electtt.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item" data-bs-interval="2000">
                        <img src="elecc.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="electttt.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
    ...
    <div class="services-container">
        ...
        <div class="service-list" id="service-list">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<p>No Electrician services available currently.</p>";
            }
            ?>
        </div>
    </div>
